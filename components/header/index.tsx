...
export default function App() {
  ...
  return (
    <header>
      ...
      <div className="text-white bg-primary p-4 lg:p-6 lg:rounded">
        <div className="lg:flex justify-between items-center border-b-primary-1 border-b-2 pb-2 mb-2">
          <h1 className="text-4xl py-2">段波文</h1>
        ...
        <div className="flex justify-between items-center">
          ...
          <ul className="block">
            <li>
              ...
              >
                <span className="pr-2">dbwcooper</span>
